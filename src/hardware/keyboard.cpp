...
public:
    PC98_System_8255() : Intel8255() {
        ...
        pinNames[PortA][0] = "DIP switch 2-1"; // Always off (Use Graphic Adapter: LV21, LS2, 5, LX2, 4, 5, SC)
        pinNames[PortA][1] = "DIP switch 2-2"; // ON: Terminal mode   OFF: BASIC
        pinNames[PortA][2] = "DIP switch 2-3"; // ON: 80 Letters/line OFF: 40 Letters/line
        pinNames[PortA][3] = "DIP switch 2-4"; // ON: 25 Lines/Screen OFF: 20 Lines/Screen
        pinNames[PortA][4] = "DIP switch 2-5"; // ON: Hold Mem SW Settings OFF: Initialize Mem SW Settings
        pinNames[PortA][5] = "DIP switch 2-6"; // ON: Disable Internal HDD OFF: Enable Internal HDD
        pinNames[PortA][6] = "DIP switch 2-7"; // Not used (FDD Motor Control for LV21, CV21, UV11)
        pinNames[PortA][7] = "DIP switch 2-8"; // ON:GDC 5MHz OFF:GDC 2.5MHz (Not used if PC-9801/E/F1,2,3/M2,3/U2/VF2/VM0,2,4)
