        ...
        while (*s != 0) {
            if (*s == '\n') {
                ...
                if (boxdraw) {
                    ...
                    if (*s=='ﾍ') ch = 0x250B;
                    else if (*s=='ｺ') ch = 0x270B;
                    else if (*s=='ﾉ') ch = 0x330B;
                    else if (*s=='ｻ') ch = 0x370B;
                    else if (*s=='ﾈ') ch = 0x3B0B;
                    else if (*s=='ｼ') ch = 0x3F0B;
...
char *getSetupLine(const char *capt, const char *cont) {
    ...
    static char line[90];
    sprintf(line, "ｺ%*c%s%*c%s%*cｺ", 12, ' ', capt, pad1, ' ', cont, pad2, ' ');
    return line;
}
...
void showBIOSSetup(const char* card, int x, int y) {
    ...
    BIOS_Int10RightJustifiedPrint(x,y,"ﾉﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍｻ", true);
...
#define DOSNAMEBUF 256
    ...
    BIOS_Int10RightJustifiedPrint(x,y,getSetupLine("", ""), true);
    BIOS_Int10RightJustifiedPrint(x,y,"ﾈﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍﾍｼ", true);
    if (machine == MCH_PC98)
